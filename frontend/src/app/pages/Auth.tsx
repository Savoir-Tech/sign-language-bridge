        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-brand-teal/10 p-8 sm:p-10">
              ...
              <p className="text-brand-teal/60 text-sm">
                {mode === "signup" ? (
                  <>
                    ...
                    <button
                      onClick={switchMode}
                      className="text-brand-gold hover:text-brand-orange transition-colors font-medium"
                    >
                      Log in
                    </button>
                  </>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {mode === "signup" && (
                <div>
                  <label className="block text-brand-teal text-sm mb-2">
                    Full Name
                  </label>
                  <input
                    type="text"
                  ...
                  />
                  {errors.fullName && (
                    <p className="text-brand-error text-xs mt-1">{errors.fullName}</p>
                  )}
                </div>
              )}
              ...
              <div>
                ...
                />
                {errors.email && (
                  <p className="text-brand-error text-xs mt-1">{errors.email}</p>
                )}
              </div>
              ...
              <div>
                ...
                {errors.password && (
                  <p className="text-brand-error text-xs mt-1">{errors.password}</p>
                )}
              </div>
              ...
              {mode === "signup" && (
                <div>
                  ...
                  {errors.confirmPassword && (
                    <p className="text-brand-error text-xs mt-1">{errors.confirmPassword}</p>
                  )}
                </div>
              )}
              ...
              {mode === "login" && (
                <div className="flex justify-end">
                  <button
                    type="button"
                    className="text-brand-gold hover:text-brand-orange text-sm transition-colors"
                  >
                    Forgot Password?
                  </button>
                </div>
              ...
              <button
                ...
                className={`w-full py-3.5 rounded-xl text-brand-neutral-light transition-all ${
                  isFormValid()
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span className="text-brand-teal text-sm">Continue with Apple</span>
                </button>
              </div>
              ...
              {mode === "signup" && (
                <p className="text-brand-teal/50 text-xs text-center leading-relaxed pt-2">
                  ...
                  <button type="button" className="text-brand-gold hover:underline">
                    Terms of Service
                  </button>{" "}
                  and{" "}
                  <button type="button" className="text-brand-gold hover:underline">
          ...
          <div className="hidden lg:block mt-6 text-center">
            <button
              onClick={() => navigate("/")}
              className="text-brand-teal/60 hover:text-brand-gold text-sm transition-colors"
            >
              ← Back to home
            </button>
          </div>
